  ...
  return (
    <DataTable
      columns={[
        ...
        { key: "source", header: "Source", render: (row) => row.proposal_source ?? row.planner_source ?? "-" },
        { key: "funding", header: "Funding", render: (row) => row.funding_source ?? "-" },
        { key: "proceeds", header: "Same-run used", align: "right", render: (row) => formatInr(row.same_run_proceeds_used_inr ?? undefined) },
